...
void MainWindow::initialize() {
    ...
    uploadFile->setText(QStringLiteral("Generate New Scene"));
...
//    realtime->sceneChanged();
    ...
    // Want this button to generate a new scene instead
    realtime->generate_scene();
}
...
//    }
    ...
    std::string sceneName = "yesmansky";
